...
module.exports = "\n<div class=\"container\">\n    <section class=\"todo\">\n      \n      <ul class=\"todo-list\">\n          <li><input class=\"new-todo\" placeholder=\"add todo\" autofocus=\"\" [(ngModel)]=\"newTodo.title\" (keyup.enter)=\"addTodo()\"></li>\n      </ul>\n      <ul *ngFor=\"let todo of todos\" class=\"todo-list\">\n          <li [class.done]=\"todo.complete\">\n            <a class=\"toggle\" (click)=\"toggleComplete(todo)\">check</a>{{todo.title}}\n            <a class=\"icon-delete\" (click)=\"removeTodo(todo)\">Delete</a>\n          </li>\n      </ul>\n    </section>\n  </div>"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.toggleComplete = function (todo) {
    ...
    AppComponent.prototype.alltodos = function () {
        var _this = this;
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__backend_service__["a" /* BackendService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__backend_service__["a" /* BackendService */]) === "function" && _a || Object])
], AppComponent);
...
var BackendService = (function () {
    ...
    BackendService.prototype.all = function () {
        return this.http
            .get(URL)
            .map(function (res) { return res.json(); });
    };
    BackendService.prototype.get = function (id) {
        return this.http
            .get(URL + '/' + id)
    ...
    BackendService.prototype.save = function (todo) {
        return this.http
            .post(URL, todo)
            .map(function (res) { return res.json(); });
    };
    BackendService.prototype.update = function (todo) {
        /*
    ...
    BackendService.prototype.delete = function (todo) {
        return this.http
            .delete(URL + '/' + todo.id);
    };
